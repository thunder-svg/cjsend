(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function i(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(n){if(n.ep)return;n.ep=!0;const s=i(n);fetch(n.href,s)}})();const l="https://YOUR-WORKER-NAME.workers.dev",r=(e,t=document)=>t.querySelector(e),p=r("#view"),L=r("#nav"),$=r("#err");let x=0;const m=e=>{x++,$.textContent=x+" error",$.hidden=!1,console.error(e)},P=["검색","비교","랭킹","라이브","로테이션","챔피언"],c={region:"kr",queue:"RANKED_SOLO_5x5"};P.forEach((e,t)=>{const i=document.createElement("button");i.className="tab",i.textContent=e,i.onclick=()=>k(t),L.appendChild(i)});function T(e){[...L.children].forEach((t,i)=>t.setAttribute("aria-selected",i===e?"true":"false"))}function k(e){T(e),e===0&&H(),e===1&&E(),e===2&&A(),e===3&&R(),e===4&&j(),e===5&&S()}const v=async e=>{const t=await fetch(e,{headers:{Accept:"application/json"}});if(!t.ok)throw new Error("HTTP "+t.status+" "+e);return t.json()},y=e=>{const t=e.reduce((a,n)=>(a.k+=n.k,a.d+=n.d,a.a+=n.a,a.w+=n.win?1:0,a),{k:0,d:0,a:0,w:0}),i=t.d?(t.k+t.a)/t.d:t.k+t.a;return{games:e.length,wins:t.w,winrate:Math.round(t.w/e.length*100),k:t.k,d:t.d,a:t.a,kda:Number(i.toFixed(2))}},M=e=>Number(e).toLocaleString();function w(e){const t=y(e.last10||[]);return`<div class="grid g2" style="align-items:center">
    <div class="row" style="gap:12px">
      ...
      <div><div style="font-weight:700">${e.name}</div><div class="muted">LV ${M(e.level||0)}</div></div>
    </div>
  ...
  </div>`,r("#reg").value=c.region,r("#f").addEventListener("submit",async e=>{e.preventDefault(),c.region=r("#reg").value;const t=r("#name").value.trim();if(!t)return;const i=new URL(l+"/v1/profile");i.searchParams.set("region",c.region),i.searchParams.set("name",t),i.searchParams.set("count","10");try{const a=await v(i.toString());r("#box").innerHTML=w(a)}catch(a){m(a),r("#box").innerHTML='<div class="muted">불러오기 실패</div>'}})}function E(){p.innerHTML=`<div class="card">
    ...
    <div id="box" style="margin-top:10px"></div>
  </div>`,r("#reg3").value=c.region,r("#reload").onclick=e,r("#tier").value="all",e();async function e(){c.region=r("#reg3").value;const t=r("#tier").value,i=new URL(l+"/v1/ladder");i.searchParams.set("region",c.region),i.searchParams.set("queue",c.queue),i.searchParams.set("tier",t);try{const n=(await v(i.toString())).entries.map((s,o)=>`<tr><td>${o+1}</td><td>${b(s.summonerName)}</td><td>${s.tier}</td><td>${M(s.leaguePoints)}</td><td>${s.wins}/${s.losses}</td></tr>`).join("");r("#box").innerHTML=`<table class="table"><thead><tr><th>#</th><th>소환사</th><th>티어</th><th>LP</th><th>전적</th></tr></thead><tbody>${n}</tbody></table>`}catch(a){m(a),r("#box").innerHTML='<div class="muted">불러오기 실패</div>'}}}function R(){p.innerHTML=`<div class="card">
